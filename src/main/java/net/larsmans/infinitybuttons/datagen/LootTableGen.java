...
public class LootTableGen extends SimpleFabricLootTableProvider {
    ...
    public void accept(BiConsumer<Identifier, LootTable.Builder> i) {
        ...
        generateCarpenterBookshelfSecretButton(i, "spruce", IBCarpenterBlocks.SPRUCE_BOOKSHELF_SECRET_BUTTON);
        generateCarpenterBookshelfSecretButton(i, "birch", IBCarpenterBlocks.BIRCH_BOOKSHELF_SECRET_BUTTON);
        generateCarpenterBookshelfSecretButton(i, "jungle", IBCarpenterBlocks.JUNGLE_BOOKSHELF_SECRET_BUTTON);
        generateCarpenterBookshelfSecretButton(i, "acacia", IBCarpenterBlocks.ACACIA_BOOKSHELF_SECRET_BUTTON);
        generateCarpenterBookshelfSecretButton(i, "dark_oak", IBCarpenterBlocks.DARK_OAK_BOOKSHELF_SECRET_BUTTON);
        generateCarpenterBookshelfSecretButton(i, "crimson", IBCarpenterBlocks.CRIMSON_BOOKSHELF_SECRET_BUTTON);
        generateCarpenterBookshelfSecretButton(i, "warped", IBCarpenterBlocks.WARPED_BOOKSHELF_SECRET_BUTTON);
    ...
    public void generateCarpenterBookshelfSecretButton(BiConsumer<Identifier, LootTable.Builder> i, String name, ItemConvertible item) {
        generateLootTable(i, "carpenter_" + name + "_bookshelf_secret_button", item);
    }
