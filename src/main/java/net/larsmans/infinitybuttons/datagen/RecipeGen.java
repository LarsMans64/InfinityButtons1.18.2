...
public class RecipeGen extends FabricRecipeProvider {
    ...
    protected void generateRecipes(Consumer<RecipeJsonProvider> i) {
        ...
        genSecretButton(i, IBCarpenterBlocks.SPRUCE_BOOKSHELF_SECRET_BUTTON, CarpenterBlocks.SPRUCE_BOOKSHELF.get());
        genSecretButton(i, IBCarpenterBlocks.BIRCH_BOOKSHELF_SECRET_BUTTON, CarpenterBlocks.BIRCH_BOOKSHELF.get());
        genSecretButton(i, IBCarpenterBlocks.JUNGLE_BOOKSHELF_SECRET_BUTTON, CarpenterBlocks.JUNGLE_BOOKSHELF.get());
        genSecretButton(i, IBCarpenterBlocks.ACACIA_BOOKSHELF_SECRET_BUTTON, CarpenterBlocks.ACACIA_BOOKSHELF.get());
        genSecretButton(i, IBCarpenterBlocks.DARK_OAK_BOOKSHELF_SECRET_BUTTON, CarpenterBlocks.DARK_OAK_BOOKSHELF.get());
        genSecretButton(i, IBCarpenterBlocks.CRIMSON_BOOKSHELF_SECRET_BUTTON, CarpenterBlocks.CRIMSON_BOOKSHELF.get());
        genSecretButton(i, IBCarpenterBlocks.WARPED_BOOKSHELF_SECRET_BUTTON, CarpenterBlocks.WARPED_BOOKSHELF.get());
