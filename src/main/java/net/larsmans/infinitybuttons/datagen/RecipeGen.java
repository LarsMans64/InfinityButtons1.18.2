...
public class RecipeGen extends FabricRecipeProvider {
    ...
    protected void generateRecipes(Consumer<RecipeJsonProvider> i) {
        ...
        generateSecretButton(i, IBCarpenterBlocks.SPRUCE_BOOKSHELF_SECRET_BUTTON, CarpenterBlocks.SPRUCE_BOOKSHELF.get());
        generateSecretButton(i, IBCarpenterBlocks.BIRCH_BOOKSHELF_SECRET_BUTTON, CarpenterBlocks.BIRCH_BOOKSHELF.get());
        generateSecretButton(i, IBCarpenterBlocks.JUNGLE_BOOKSHELF_SECRET_BUTTON, CarpenterBlocks.JUNGLE_BOOKSHELF.get());
        generateSecretButton(i, IBCarpenterBlocks.ACACIA_BOOKSHELF_SECRET_BUTTON, CarpenterBlocks.ACACIA_BOOKSHELF.get());
        generateSecretButton(i, IBCarpenterBlocks.DARK_OAK_BOOKSHELF_SECRET_BUTTON, CarpenterBlocks.DARK_OAK_BOOKSHELF.get());
        generateSecretButton(i, IBCarpenterBlocks.CRIMSON_BOOKSHELF_SECRET_BUTTON, CarpenterBlocks.CRIMSON_BOOKSHELF.get());
        generateSecretButton(i, IBCarpenterBlocks.WARPED_BOOKSHELF_SECRET_BUTTON, CarpenterBlocks.WARPED_BOOKSHELF.get());
